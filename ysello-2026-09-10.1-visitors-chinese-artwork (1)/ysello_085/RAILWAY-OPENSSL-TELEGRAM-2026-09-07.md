...
## Telegram 2026-09-07.8
Use `TELEGRAM_CHAT_ID=-1003862484719`. Admin now includes a Telegram visitor alerts panel with one-click test/detect/select controls, and public pages send a browser beacon to `/api/visitor/notify`.
