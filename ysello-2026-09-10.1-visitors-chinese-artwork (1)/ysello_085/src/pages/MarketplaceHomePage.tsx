...
import { storefrontNavigationCategories } from "../commerce/storefrontCategories";
import {
...
export function MarketplaceHomePage() {
  ...
  const { add } = useCart();
  const { products } = useMarketplaceProductFeed();
      ...
      <div className="ys-home-container">
        ...
        <section className="ys-company-section" id="categories">
          <header className="ys-section-heading">
            <div>
              <span className="ys-eyebrow"><UiText value="SHOP BY CATEGORY" /></span>
              <h2>
