...
function storedLocale(): LocaleCode {
  ...
  let value: LocaleCode | null = null;
  try { value = localStorage.getItem("ysello-locale") as LocaleCode | null; } catch {}
...
function storedCurrency(): CurrencyCode {
  ...
  let value: CurrencyCode | null = null;
  try { value = localStorage.getItem("ysello-currency") as CurrencyCode | null; } catch {}
  return value && validCurrencies.has(value) ? value : storedLocale() === "en" ? "USD" : storedLocale() === "ru" ? "RUB" : "CNY";
}
...
export function LocaleProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    try { localStorage.setItem("ysello-locale", locale); } catch {}
  }, [locale]);
  useEffect(() => {
    try { localStorage.setItem("ysello-currency", currency); } catch {}
  }, [currency]);
