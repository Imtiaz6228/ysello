...
export const marketplaceTaxonomy: MarketplaceTaxonomyItem[] = [
  ...
  },
  {
    ...
    description:
      "Browse transferable social-media account inventory by platform, account age, followers and posting history.",
    accent: "rose",
    icon: "SOC",
    subcategories: [
      {
        ...
        name: "Facebook",
        description: "Facebook account inventory.",
        children: socialAccountInventory("facebook", "Facebook"),
      },
      {
        slug: "instagram-creator-tools",
        name: "Instagram",
        description: "Instagram account inventory.",
        children: socialAccountInventory("instagram", "Instagram"),
      },
      {
        slug: "threads-social-products",
        name: "Threads",
        description: "Threads account inventory.",
        children: socialAccountInventory("threads", "Threads"),
      },
      {
        slug: "x-social-products",
        name: "X / Twitter",
        description: "X / Twitter account inventory.",
        children: socialAccountInventory("x", "X / Twitter"),
      },
      {
        slug: "tiktok-creator-tools",
        name: "TikTok",
        description: "TikTok account inventory.",
        children: socialAccountInventory("tiktok", "TikTok"),
      },
      {
        slug: "telegram-social-products",
        name: "Telegram",
        description: "Telegram account inventory.",
        children: socialAccountInventory("telegram", "Telegram"),
      },
      {
        slug: "discord-social-products",
        name: "Discord",
        description: "Discord account inventory.",
        children: socialAccountInventory("discord", "Discord"),
      },
      {
        slug: "snapchat-social-products",
        name: "Snapchat",
        description: "Snapchat account inventory.",
        children: socialAccountInventory("snapchat", "Snapchat"),
      },
      {
        slug: "whatsapp-social-products",
        name: "WhatsApp",
        description: "WhatsApp account inventory.",
        children: socialAccountInventory("whatsapp", "WhatsApp"),
      },
      {
        slug: "youtube-creator-tools",
        name: "YouTube",
        description: "YouTube account and channel inventory.",
        children: socialAccountInventory("youtube", "YouTube"),
      },
      {
        slug: "streaming-creator-tools",
        name: "Twitch",
        description: "Twitch account and channel inventory.",
        children: socialAccountInventory("streaming", "Twitch"),
      },
      {
        slug: "linkedin-social-products",
        name: "LinkedIn",
        description: "LinkedIn account inventory.",
        children: socialAccountInventory("linkedin", "LinkedIn"),
      },
      {
        slug: "pinterest-social-products",
        name: "Pinterest",
...
export const retiredSocialMediaCategorySlugs = new Set([
  ...
  "discord",
  "discord-server-kits",
  "discord-moderation-workflows",
  "telegram",
  "telegram-channel-kits",
  "telegram-support-workflows",
  "tiktok",
  "tiktok-hook-libraries",
  "tiktok-storyboards",
  "tiktok-content-calendars",
  "tiktok-editing-assets",
  "youtube-thumbnail-templates",
  "youtube-script-systems",
  "youtube-channel-branding",
  "youtube-editing-services",
  "streaming-overlays",
  "stream-alert-packs",
  "stream-channel-branding",
  "community-tools",
  "community-accounts",
  "community-moderation-tools",
  "social-marketing-tools",
  "social-marketing-accounts",
  "linkedin-content-kits",
