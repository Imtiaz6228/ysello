...
const socialAccountInventory = (
  ...
  {
    slug: `${platformSlug}-new-accounts`,
    name: "Fresh",
    description: `Fresh ${platformName} account inventory.`,
  },
  {
    slug: `${platformSlug}-old-accounts`,
    name: "Aged",
    description: `Aged ${platformName} account inventory.`,
  },
  {
    slug: `${platformSlug}-accounts-with-followers`,
    name: "Followers",
    description: `${platformName} accounts with an existing audience.`,
  },
  {
    slug: `${platformSlug}-accounts-with-posts`,
    name: "Posts",
    description: `${platformName} accounts with posting history.`,
  },
];
...
const socialPlatform = (
  ...
  name: platformName,
  description: `${platformName} account inventory.`,
  children: socialAccountInventory(platformSlug, platformName),
});
...
export const marketplaceTaxonomy: MarketplaceTaxonomyItem[] = [
  ...
  },
  {
    ...
    description:
      "Browse social account inventory by platform and account type.",
    accent: "rose",
    icon: "SOC",
    subcategories: [
      ...
      socialPlatform("streaming", "Twitch"),
...
export const retiredSocialMediaCategorySlugs = new Set([
  ...
  "threads-social-products",
  "x-social-products",
  "tiktok-creator-tools",
  "telegram-social-products",
  "discord-social-products",
  "snapchat-social-products",
  "whatsapp-social-products",
  "youtube-creator-tools",
  "streaming-creator-tools",
  "linkedin-social-products",
  "pinterest-social-products",
  "reddit-social-products",
  "instagram",
