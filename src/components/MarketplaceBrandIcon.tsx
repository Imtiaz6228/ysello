...
const platformIcons: Record<string, IconType> = {
  ...
  apple: FaApple,
  android: FaAndroid,
  "pubg-mobile": FaGamepad,
  "free-fire": FaGamepad,
  "genshin-impact": FaGamepad,
  "honkai-star-rail": FaGamepad,
  "wuthering-waves": FaGamepad,
  "zenless-zone-zero": FaGamepad,
...
const brandPatterns: Array<[string, RegExp]> = [
  ["pubg-mobile", /\bpubg(?:\s*mobile)?\b/i],
  ["free-fire", /\bfree\s*fire\b|\bgarena\s*free\s*fire\b/i],
  ["genshin-impact", /\bgenshin(?:\s*impact)?\b/i],
  ["honkai-star-rail", /\bhonkai(?:\s*star\s*rail)?\b|\bstar\s*rail\b/i],
  ["wuthering-waves", /\bwuthering\s*waves?\b/i],
  ["zenless-zone-zero", /\bzenless\s*zone\s*zero\b|\bzzz\b/i],
  ["mobile-legends", /\bmobile\s*legends?\b|\bmlbb\b/i],
