...
const engaged = { page: "https://ysello.com/catalog", dwellSeconds: 40, visibilitySeconds: 35, interactions: 2 };
...
test("visitor must show visible time, interaction and a public page", async () => {
  for (const patch of [{ dwellSeconds: 20 }, { visibilitySeconds: 0 }, { interactions: 0 }, { visibilitySeconds: undefined }, { page: "https://ysello.com/admin" }, { page: "https://ysello.com/brand-icons/gmail.svg" }, { page: "https://example.com/" }]) {
